...
Cette thèse a été réalisée entre novembre 2014 et novembre 2017 au Laboratoire Vision et Ingénierie des Contenus (LVIC) du CEA LIST, à Saclay (91). L'ensemble des travaux ont été réalisés en cotutelle avec l'unité de recherche ISIT (Institut des Sciences de l'Image pour les Techniques interventionnelles, UMR 6284 UdA, CNRS) à Clermont-Ferrand.
...
\begin{itemize}
    ...
    \item Reconstruction d'un modèle géométrique canonique invariant aux changements de courbure. Nous reconstruisons notre quadrique à partir des ellipses correspondant aux contours de spécularités transformées afin de revenir à une surface planaire (JOLIMAS primal).
