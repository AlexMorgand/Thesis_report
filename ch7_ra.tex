...
\end{itemize}
Dans ce chapitre, nous détaillons l'ensemble des composants implémentés pour assurer le bon fonctionnement de notre modèle dans un contexte de réalité augmentée large ce qui inclue la gestion des plusieurs sources de lumière simultanément pouvant s'allumer et s'éteindre, la capacité à synthétiser des spécularités ainsi qu'une nouvelle texture pour une application de retexturing et une analyse du temps d'exécution de notre méthode.
...
Pour chaque images utilisées pour la reconstruction de la quadrique, nous utilisons les spécularités prédites et les spécularités détectées dans les images afin de reconstruire un motif de spécularité.
...
%===============================================================================
Afin d'assurer le bon fonctionnement de notre modèle dans un contexte de réalité augmentée, plusieurs choses doivent être prises en compte. La possibilité d'avoir plusieurs sources de lumière pouvant potentiellement s'allumer ou s'éteindre. Nous avons également proposé une application de retexturing qui consiste à substituer la texture initiale de la surface en une autre. La difficulté de cette application est de synthétiser la nouvelle texture ainsi que les spécularités cohérentes qui la parcoure. Nous avons illustré nos résultats sur de nombreuses réelles et prouvé que le modèle JOLIMAS est efficace et adapté à un contexte de réalité augmenté.
