...
\begin{table*}
  ...
  \begin{tabular}{|c|c|c|c|c|c|}
      ...
      \hline
      \specialcell{\cite{stehle2006removal}}  & YUV & Automatique & Aucun & \specialcell{OM} & Image\\
      \hline
...
\begin{figure}
    ...
    \subfigure[]
    {
      \includegraphics[width=0.43\linewidth]{tablesaturated}
      \label{fig:tablesaturated}
    }
    \subfigure[]
    {
      \includegraphics[width=0.43\linewidth]{contrast}
      \label{fig:contrast}
    }
...
\begin{figure*}
  \centering
	  \subfigure[]
	  {
      \includegraphics[width=0.42\linewidth]{grad2}
      \label{fig:grad2}
    }
	  \subfigure[]
	  {
      \includegraphics[width=0.4\linewidth]{gradient}
      \label{fig:gradient}
    }
	  \subfigure[]
	  {
...
\begin{table}
  ...
  \begin{tabular}{|c|c|c|}
      ...
      \hline
      \specialcell{Temps (in seconds)} & \specialcell{0.0584} & \specialcell{\textbf{0.0371}} \\
      \hline  
      Contour (in \%)  & \specialcell{70.3} & \specialcell{\textbf{80.29}} \\
      \hline    
       \specialcell{Centre de  gravité in \%} &  \specialcell{67.2} & \specialcell{\textbf{78.13}} \\
      \hline  
  \end{tabular}
  \par
  \bigskip
