...
Nous utilisons l'approche de \cite{cross1998quadric} qui reconstruit une quadrique duale $\mathtt{Q}^*$ à partir de plusieurs coniques duales $\mathtt{C}^*$ en linéarisant la relation :
\begin{equation}
