...
\ref{fig:hard_case2}.
Notre modèle est mis en échec lorsque la surface en question est constitué de différents matériaux. Ce cas va provoquer un changement d'échelle de la spécularité lorsqu'elle se déplacera d'un matériau à un autre et ainsi impactera négativement la reconstruction de quadrique de notre modèle. Un exemple de ce cas est illustré à la figure \ref{fig:hard_case1}
